...
date: '2020-05-24'
slug: rayshading-the-big-sur-marathon
categories: []
tags: []
toc: []
images: ~
...
images_folder <- paste0("2020-05-24-", "rayshading-the-big-sur-marathon", "_files")
# dir.create(here::here("static", "post", images_folder))
path_to_project <- file.path("C:", "Users", "Josh", "Dropbox", "Projects", "rayshader")

current.folder <- file.path(path_to_project, "media")
...
```{r path to downloads, include=FALSE, message=FALSE}
path_to_data <- file.path("C:", "Users", "Josh", "Dropbox", "Projects", "rayshader", "data")
```

![](`r paste0('/post/', images_folder, '/banner_cropped.png')`)
...
![](`r paste0('/post/', images_folder, '/piano.jpg')`)
...
bigsur_gpx_enr <-
  ...
  mutate(time = as_datetime(time),
         elapsed_time = ifelse(dplyr::row_number() == 1, 0,
                               time - lag(time)),
         distance_from_prior = ifelse(row_number() == 1, 0,
                                      sf::st_distance(geometry,
                                                      lag(geometry, default = st_as_sfc("POINT(EMPTY)")),
                                                      by_element = TRUE)),
...
```
![](`r paste0('/post/', images_folder, '/bigsur_marathon.mp4')`){width=1000 height=800}
